...
const NodeFrame = ({
	...
	>
		<div
			className={`workflow-node-drag-handle flex cursor-grab items-center justify-center gap-1.5 rounded-t-2xl px-3 py-1.5 active:cursor-grabbing ${accentClass}`}
			title="Drag to move"
		>
			<FiMove className="text-xs text-white/90" />
	...
	<div className="relative">
		...
		>
			<div className="flex flex-wrap gap-2">
				...
				<Tag className="m-0 border-none bg-slate-100 text-slate-600">Start</Tag>
			</div>
		</NodeFrame>
		<Handle
			type="source"
	...
	<div className="relative">
		...
		>
			<div className="flex flex-wrap gap-2">
				...
				<Tag className="m-0 border-none bg-slate-100 text-slate-600">End</Tag>
			</div>
		</NodeFrame>
	</div>
);
